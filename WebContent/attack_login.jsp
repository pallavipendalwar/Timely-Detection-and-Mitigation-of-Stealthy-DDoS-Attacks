                            ...
                            <div id="content">
                                <section>
                                    <div class="post">
                                        ...
                                        <img src="images/attack.jpg" width="1150" height="350"><br>
                                        <fieldset id="ff">
                                            <br>
                                            <h1 style="position: relative; left: 180px;font-size: 30px; color: black;">Attacker Login</h1><br>
                                            <form action="attack_log_action.jsp" name="ulogin" method="post" onsubmit="return validation()"> 
                                                ATTACKER ID:<br>
