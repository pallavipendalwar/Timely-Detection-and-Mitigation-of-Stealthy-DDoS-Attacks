                        ...
                        <div class="12u" id="menu">
                            <div id="menu-wrapper">
                                <nav class="mobileUI-site-nav">
                                    <ul>
                                        <li class="current_page_item"><a href="user_page.jsp">Homepage</a></li>
                            ...
                            <div id="content">
                                <section>
                                    <div class="post">
                                        ...
                                        %>
                                        <p style="font-size: 20px;">   Welcome ! <font style="color: black"><%=uname%> <font></font></p> 
                                        <center style="position: relative;left: 200px">
                                            <img src="images/prof.png" width="600" >
                                        </center>
                                    </div>
                                </section>
                            </div>
